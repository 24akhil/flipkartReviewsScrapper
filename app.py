...
def index():
    if request.method == 'POST':
        ...
        try:
            connectionString = 'mongodb+srv://akhil:mongo%40123@cluster0.izl43.mongodb.net/test?authSource=admin&replicaSet=atlas-fxp4il-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true';
            # dbConn = pymongo.MongoClient("mongodb://localhost:27017/")  # opening a connection to Mongo
            dbConn = pymongo.MongoClient(connectionString)
